...
import { ICoreCommandsService, CoreCommandsService } from 'vs/editor/browser/services/coreCommandsService';
...
registerSingleton(ICoreCommandsService, CoreCommandsService, true);
